...
const reducer = (state, action) => {
  switch (action.type) {
    ...
    case "FETCH_SUCCESS":
      return { ...state, loading: false, trip: action.payload.trip };
    case "FETCH_FAIL":
...
const ViewTrip = () => {
  ...
  const [{ loading, error, trip }, dispatch] = useReducer(reducer, {
    loading: true,
    error: "",
  });
                          ...
                          <div className="row">
                            ...
                            <div className="col-md-4">
                              <div className="form-group">
                                ...
                                <p>{trip.destination.destinationAddress}</p>
                              </div>
                            </div>
                            ...
                            <div className="col-md-4">
                              <div className="form-group">
                                ...
                                <p>{getDateTime(trip.createdAt)}</p>
                              </div>
                            </div>
                            ...
                            <div className="col-md-4">
                              <div className="form-group">
                                ...
                                <p>{getDateTime(trip.updatedAt)}</p>
                              </div>
                            </div>
                          </div>
                          {/* /.card-body */}
